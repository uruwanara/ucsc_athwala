...
export default function Viewauctionstd(){
    ...
    return(
        ...
        <div>
            ...
            <p ><b>Auctions <div className="addauc"><i class="bi bi-arrow-right"></i><Link to="/stdcreateauc">Add Auction</Link></div> </b></p></div>
            <div className="widgetSm">
                ...
                <Link to="/auctionstd"><div className="view"><p>View More <i class="bi bi-arrow-right-circle"></i></p></div></Link>
                <hr></hr></div>
                <div className="box2">
                <p>Seller Name</p>
