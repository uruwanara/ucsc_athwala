...
export default function Side() {
    ...
    <div className="sidebar-custom">
                <Link to="/pstddashboard"> <i className="fa fa-tachometer" aria-hidden="true" style={{color:'#ff6411',padding:10}}></i> Dashboard</Link>
                <Link to="/Job">  <i className="fa fa-handshake-o" aria-hidden="true" style={{color:'#ff6411',padding:10}}></i> Job Vacancy</Link>
                <Link to="/pstDonation"> <i className="fa fa-users" aria-hidden="true" style={{color:'#ff6411' ,padding:10}}></i> Donation</Link>
