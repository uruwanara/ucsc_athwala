...
export default function Side() {
    ...
    <div className="sidebar-custom">           
                ...
                <a href="#contact"> <i className="fa fa-flag" aria-hidden="true" style={{color:'orange',padding:10}}></i> Union members</a>
                <a href="#contact"> <i className="fa fa-video-camera" aria-hidden="true" style={{color:'orange',padding:10}}></i> Notification</a>
                <a href="#contact"> <i className="fa fa-comments" aria-hidden="true" style={{color:'orange',padding:10}}></i> Reports</a>
